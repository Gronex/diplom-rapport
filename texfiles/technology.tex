...
\begin{table}[h]
  \resizebox{\linewidth}{!}{%
    \begin{tabular}{l|l l}
      & Pros & Cons\\
      \hline
      \textbf{Static serving} & Dynamic content & Single frontend \\
      & Hidden code & Mixing of front and backend code\\
      \hline
      \textbf{SOAP} & Possible multiple frontends & XML\\
      & Extendable & Not many consuming libraries for web\\
      & Custom error types & \\
      & Dynamic content\\
      \hline
      \textbf{REST} & Possible multiple frontends & Easy to break standards\\
