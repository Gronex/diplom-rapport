...
The structure of the system follows the onion model\todo{Reference to onion model}, which means that it is build up of layers like it can be seen on figure~\ref{fig:Onion architecture}.
...
\end{figure}
\todo{Cite}
% http://www.matthidinger.com/images/www_matthidinger_com/Windows-Live-Writer/ff0d136aee1f_88EA/image_2.png
