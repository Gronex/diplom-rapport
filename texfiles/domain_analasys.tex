...
\end{enumerate}
\textbf{Extentions}: \todo{Look up optional flow}
\begin{itemize}
  \item [0a] User wants to add contact
  \begin{enumerate}
  ...
  \end{enumerate}
  \item [0b] User wants to add contact that does not exist
  \begin{enumerate}
    \item User writes contact name
    \item List of related users show up
    \item User selects create new
  \end{enumerate}
  \item [2a] Company does not exist
  \begin{enumerate}
